...
export const services: Service[] = [
  {
    ...
    subtitle: "Pixel-Perfect UI Architecture",
    description:
      "Transforming Figma, Adobe XD, or PSD mockups into production-ready React.js and Next.js web applications with clean TypeScript, Tailwind CSS, and SCSS.",
    quote: "Every pixel, spacing, and interaction — implemented exactly as designed with reusable component architecture.",
    tags: ["Figma to React", "Next.js", "Tailwind CSS", "TypeScript"],
    color: "from-[#64ffda] to-[#38bdf8]",
  ...
  {
    icon: Layers,
    title: "Frontend SaaS & Web Apps",
    subtitle: "Scalable Enterprise Frontends",
    description:
      "Engineering full-scale frontend systems for SaaS platforms, analytical dashboards, POS/CRM platforms, and e-commerce web applications.",
    quote: "Modular, scalable state management (Redux/Zustand) built for seamless growth and team handover.",
    tags: ["SaaS Frontends", "State Management", "Complex Forms", "Role Routing"],
    color: "from-[#38bdf8] to-[#64ffda]",
  ...
  {
    icon: Server,
    title: "REST API & AI Service Integration",
    subtitle: "Dynamic Real-Time Data Handling",
    description:
      "Seamlessly connecting frontends with complex backend REST APIs and AI services (including Google Gemini AI) for dynamic real-time data rendering.",
    quote: "Reliable data flows with optimistic UI updates, proper error handling, and robust loading states.",
    tags: ["REST APIs", "Gemini AI", "Real-Time Data", "Async State"],
    color: "from-[#64ffda] to-[#38bdf8]",
    borderColor: "border-[#64ffda]/20",
    hoverShadow: "hover:shadow-[#64ffda]/20",
  },
  {
    ...
    subtitle: "20–40% Page Speed Enhancement",
    description:
      "Auditing and optimizing web applications through code splitting, lazy loading, image compression, and bundle size reduction for top Lighthouse scores.",
    quote: "Blazing fast page load speeds and smooth rendering across mobile and desktop devices.",
    tags: ["Core Web Vitals", "Lazy Loading", "Lighthouse 95+", "Bundle Shrinking"],
    color: "from-[#38bdf8] to-[#64ffda]",
    borderColor: "border-[#38bdf8]/20",
    hoverShadow: "hover:shadow-[#38bdf8]/20",
  },
  {
    ...
    subtitle: "Engaging Motion Design",
    description:
      "Elevating user interfaces with fluid page transitions, interactive scroll effects, and subtle micro-interactions using Framer Motion and GSAP.",
    quote: "Fluid 60fps animations that delight users without impacting performance.",
    tags: ["Framer Motion", "GSAP Animations", "Micro-Interactions", "Interactive UI"],
    color: "from-[#64ffda] to-[#38bdf8]",
    borderColor: "border-[#64ffda]/20",
    hoverShadow: "hover:shadow-[#64ffda]/20",
  },
